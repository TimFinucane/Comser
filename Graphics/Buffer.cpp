...
Buffer::Buffer( UpdateFrequency frequency, size_t length, const void* data )
    : Buffer( frequency )
{
...
void Buffer::recreate( size_t length, const void* data )
{
...
void Buffer::replace( size_t start, size_t length, const void* data )
{
    glBindBuffer( GL_ARRAY_BUFFER, _buffer );
